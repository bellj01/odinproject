...
# Adjusts the indexing value for shifter based on whether the shiftingvalue is in array bounds
# First loop is for checking rightwards shifts, second is for leftwards shifts
